...
from .training.filtered_networks import * #Either "filtered LReLU" or regular LReLu
...
class CNO(nn.Module):
    def __init__(self,  
                 ...
                 residual_connection = False # Add residual connections in the network to output full wavefield
                ):
